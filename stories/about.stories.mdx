...
they're not part of an `npm` package. Just copy what you need and use it - **all of the hooks
are independent of each other**.

## Source Code
[Custom React Hooks](https://github.com/raduGaspar/custom-react-hooks)
